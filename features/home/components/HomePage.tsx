...
const HomePage = () => {
  return (
    <div className="flex min-h-screen flex-col items-center p-9 lg:justify-center lg:p-12">
      <header className="mb-7 w-full text-sm max-w-4xl">
        <div className="flex items-center justify-end">
          <Link
            href="/dashboard"
            className="inline-block border border-border rounded-sm px-4 py-2 text-sm leading-normal"
          >
            Dashboard
          </Link>
        </div>
      </header>
      <section className="flex w-full items-start justify-center lg:grow">
        <main className="flex w-full h-full flex-col lg:flex-row max-w-83.75 lg:max-w-4xl">
          <div className="flex-1 rounded-br-md rounded-bl-md p-6 pb-12 text-[13px] leading-5 lg:rounded-tl-md lg:rounded-br-none lg:px-26 lg:py-28 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
            ...
            <ul className="mb-4 flex flex-col lg:mb-8">
              <li className="relative flex items-center gap-6 py-3 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                <span className="relative bg-white py-1 dark:bg-[#161615]">
                  <span className="flex h-4.5 w-4.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]">
                    <span className="h-2 w-2 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]"></span>
                  </span>
                </span>
                <span>
                  Read the
              ...
              <li className="relative flex items-center gap-6 py-3 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                <span className="relative bg-white py-1 dark:bg-[#161615]">
                  <span className="flex h-4.5 w-4.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]">
                    <span className="h-2 w-2 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]"></span>
                  </span>
            ...
            <ul className="flex gap-3 text-sm leading-normal">
              <li>
                <a
                  ...
                  target="_blank"
                  className="inline-block rounded-sm border border-black bg-[#1b1b18] px-7 py-2 text-sm leading-normal text-white hover:border-black hover:bg-black dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A] dark:hover:border-white dark:hover:bg-white"
                >
                  Deploy now
                </a>
              </li>
          ...
          <div className="relative -mb-px aspect-335/376 w-full overflow-hidden rounded-t-lg lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-109.5 lg:rounded-t-none lg:rounded-r-lg bg-[#fff2f2] dark:bg-[#1D0002] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
